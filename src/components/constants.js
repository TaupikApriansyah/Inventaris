...
export const MENU_ITEMS = [
    ...
    { label: "Data Induk (BMD)", icon: "📋", id: 'master_data' },
    { label: "Laporan & KIR", icon: "🖨️", id: 'reports' },
    { label: "Cetak Label Aset", icon: "🏷️", id: 'print_labels' },
    { label: "Konfigurasi", icon: "🛠️", id: 'configuration' },
];
...
export const KIB_TYPES = {
    A: { label: 'KIB A: Tanah', icon: '🌳', mode: MODES.ADD_KIB_A, color: 'green' },
    B: { label: 'KIB B: Peralatan & Mesin', icon: '🖥️', mode: MODES.ADD_KIB_B, color: 'blue' },
    C: { label: 'KIB C: Gedung & Bangunan', icon: '🏛️', mode: MODES.ADD_KIB_C, color: 'orange' },
};
...
export const KIB_A_FIELDS = [
    ...
    { label: "Status Tanah", name: "status_tanah", type: "select", options: ["Hak Milik", "Hak Pakai", "Hak Guna Bangunan", "Lainnya"] },
    { label: "Luas Tanah (m²)", name: "luas_tanah", type: "number", min: 0, required: true },
    ...
    { label: "Tahun Perolehan", name: "tahun_perolehan", type: "number", min: 1900, max: new Date().getFullYear(), required: true },
    { label: "Harga Perolehan (Rp)", name: "harga_perolehan", type: "number", required: true, min: 0 },
...
export const KIB_B_FIELDS = [
    ...
    { label: "Ukuran / CC", name: "ukuran_cc", type: "text", placeholder: "Contoh: 150 CC" },
    { label: "Bahan", name: "bahan", type: "select", options: ["Metal", "Kayu", "Plastik", "Lainnya"] },
    ...
    { label: "Asal-usul Perolehan", name: "asal_usul", type: "text" },
    { label: "Harga Perolehan (Rp)", name: "harga_perolehan", type: "number", required: true, min: 0 },
    { label: "Kondisi Barang", name: "kondisi", type: "select", options: ["Baik", "Rusak Ringan", "Rusak Berat"] },
...
export const KIB_C_FIELDS = [
    { label: "Nama Gedung/Bangunan", name: "nama_bangunan", type: "text", required: true },
    { label: "Kode Barang", name: "kode_barang", type: "text", required: true },
    { label: "Nomor Register", name: "noreg", type: "text" },
    { label: "Kondisi Bangunan", name: "kondisi_bangunan", type: "select", options: ["Baik", "Rusak Ringan", "Rusak Berat"] },
    { label: "Kontruksi Bangunan", name: "kontruksi", type: "select", options: ["Baja", "Beton", "Semi Permanen"] },
    { label: "Luas Lantai (m²)", name: "luas_lantai", type: "number", min: 0, required: true },
    { label: "Jumlah Lantai", name: "jumlah_lantai", type: "number", min: 1 },
    { label: "Letak / Alamat Gedung", name: "letak_alamat", type: "text" },
    { label: "Dokumen Kepemilikan (No)", name: "no_dokumen", type: "text", placeholder: "IMB/Sertifikat No." },
    { label: "Tanggal Dokumen", name: "tgl_dokumen", type: "date" },
    { label: "Status Tanah", name: "status_tanah", type: "text", placeholder: "Milik Pemerintah / Mandiri" },
    { label: "Tahun Perolehan", name: "tahun_perolehan", type: "number", required: true, min: 1900, max: new Date().getFullYear() },
